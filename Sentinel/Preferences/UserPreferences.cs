...
namespace Sentinel.Preferences
{
    ...
    public class UserPreferences : ViewModelBase, IUserPreferences
    {
        ...
        /// <summary>
        /// Gets an enumerable list of the available date formating options.
        /// </summary>
